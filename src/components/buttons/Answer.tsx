...
const AnswerButton = (props: ButtonHTMLAttributes<HTMLButtonElement>) => {
  return (
    <button type="button" {...props} className={styles.answerButton}>
      <svg className={styles.border} width="389" height="72" viewBox="0 0 389 72" fill="none"
